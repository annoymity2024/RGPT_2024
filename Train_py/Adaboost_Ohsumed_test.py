...
def post_process(task, response: str):
    ...
    labels_dict = {"sentiment": ["positive", "neutral", "negative", "pos", "neg", "neu", "0", "1"],
                   "News": ["world", "sports", "bussiness", "technology"],
                   "Topic": ["c01", "c02", "c03", "c04", "c05", "c06", "c07", "c08", "c09", "c10", "c11", "c12", "c13", "c14", "c15", "c16", "c17", "c18", "c19", "c20", "c21", "c22", "c23"],
    ...
    synonymy_dict = {"sentiment": {("positive", "pos", "1"): 1, ("neutral", "neu"): 0, ("negative", "neg", "0"): 2},
                     "News": {("world"): 1, ("sports"): 2, ("bussiness"): 3, ("technology"): 4},
                     "Topic": {("c01"):1, ("c02"):2, ("c03"):3, ("c04"):4, ("c05"):5, ("c06"): 6, ("c07"): 7, ("c08"): 8, ("c09"):9, ("c10"):10, ("c11"):11, ("c12"):12,
                               ("c13"):13, ("c14"):14, ("c15"):15, ("c16"):16, ("c17"):17, ("c18"):18, ("c19"):19, ("c20"):20, ("c21"):21, ("c22"):22, ("c23"):23},
...
def main():
    ...
    output_dir = "Adaboost_Ohsumed_59"
    ...
    TEST_SET = "./train_dataset/Ohsumed_test.json"
    TASK = "Topic"
    common = []
    pred_labels = []
    true_labels = generate_true_labels(TASK, TEST_SET)  # 先将测试集的 标签 数字化，方便后续直接评测计算。
    output_csv = "./mid_result/Ohsumed_59.csv"
     # 1---分词器处理
