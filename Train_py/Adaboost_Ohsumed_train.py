...
def post_process(task, response: str):
    ...
    synonymy_dict = {"sentiment": { ("positive", "pos", "1") : 1, ("neutral", "neu") : 0, ("negative", "neg", "0") : 2 },
                      "sarcasm": { ("world") : 1, ("sports") : 2 , ("bussiness") : 3, ("technology") : 4},
...
def main():
    ...
    LEARNING_RATE = 3e-5  # from the original paper
    ...
    # 1---分词器处理
    #设置基础模型与训练数据的路径
    TRAIN_DIR = "./train_dataset/Ohsumed_train.json"
    DEV_DIR = "./train_dataset/Ohsumed_dev.json"
    output_dir = "Adaboost_Ohsumed_19"
